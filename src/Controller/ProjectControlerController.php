...
class ProjectControlerController extends AbstractController
{
    ...
    public function show(int $id, ManagerRegistry $doctrine): Response {
        ...
        if (!$project){
            return $this->json('no projectfound for id ' . $id, 404);
        }
        $data = [
            'id' => $project->getId(),
    ...
    public function delete(int $id, ManagerRegistry $doctrine): Response
    {
        ...
        return $this->json('deleted a project succefully with id ' . $id);
    }
